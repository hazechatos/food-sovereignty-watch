...
## Files
- `src/index.html`: app structure and controls
- `src/styles.css`: split layout, styles, tooltip
- `src/main.js`: data loading, state, map, charts, updates
...
Current `src/main.js` also maps your existing CSV fields (`country`, FAOSTAT product names) to this schema.
